...
class BookManager: NSObject {
    ...
    static let categories = [Category(id: 215, name: "Ensayos/Novelas"),
                             Category(id: 2857, name: "Filosofía"),
                             Category(id: 893, name: "Textos académicos"),
                             Category(id: 1061, name: "Revistas"),]
...
extension BookManager: URLSessionDelegate {
